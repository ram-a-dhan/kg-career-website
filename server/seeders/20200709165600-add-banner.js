...
module.exports = {
  up: async(queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('banners', [{
      ...
      subtitle: '',
      banner_path: 'http://dev.growwithkg.id/images/1294382749372.png',
      createdAt: new Date(),
      updatedAt: new Date()
    }, {
      name: 'Who We Are',
      ...
      banner_path: 'http://dev.growwithkg.id/images/2412421421442.png',
      createdAt: new Date(),
      updatedAt: new Date()
    }, {
      name: 'Join Us',
      ...
      banner_path: 'http://dev.growwithkg.id/images/3322198329382.png',
      createdAt: new Date(),
      updatedAt: new Date()
    }], {});
  },

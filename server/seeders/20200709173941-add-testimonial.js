...
module.exports = {
  up: async(queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('testimonials', [{
      ...
      photo_path: 'http://dev.growwithkg.id/images/3234323432432.png',
      createdAt: new Date(),
      updatedAt: new Date()
    }, {
      ...
      photo_path: 'http://dev.growwithkg.id/images/8767382843829.png',
      createdAt: new Date(),
      updatedAt: new Date()
    }, {
      ...
      photo_path: 'http://dev.growwithkg.id/images/3243242342188.png',
      createdAt: new Date(),
      updatedAt: new Date()
    }], {});
  },
